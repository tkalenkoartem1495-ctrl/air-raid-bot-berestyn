...
Прочитай цей батч повідомлень (зібраний за останні 5 хвилин). Знайди дійсні скарги або питання про відключення світла чи води і сформуй готові попередження.
...
class UtilityMonitor:
    ...
    async def _process_batch_loop(self):
        """Фонова задача, яка кожні 5 хвилин відправляє батч в Gemini."""
        while True:
