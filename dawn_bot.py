...
FALLBACK_GREETINGS = [
    ...
    "🌅 Чудового ранку, Берестин! Бажаємо, щоб цей день залишив по собі тільки приємні спогади. Бережіть себе! ☕️",
    ...
    "🌤 Добрий ранок, Берестин! Нехай сьогодні все йде за планом, а непередбачувані ситуації будуть лише приємними. 🇺🇦",
    "🌅 Сонячного ранку, Берестин! Бажаємо продуктивного дня та затишного вечора. ☕️",
    "☀️ Вітаємо з новим днем, Берестин! Нехай він буде сповнений добрих новин і теплих зустрічей. 🇺🇦",
    ...
    "🌅 Ранкова кава чекає, Берестин! Бажаємо легкості в думках і рішучості в діях на весь сьогоднішній день. ☕️",
    "☀️ Доброго ранку, Берестин! Нехай цей день стане чудовим стартом для чогось нового і прекрасного. 🇺🇦",
    ...
    "🌅 Доброго ранку, Берестин! Заряджаємось позитивом і йдемо підкорювати цей день. Успіхів усім! ☕️",
...
♑️ Козеріг — ідеальний час для планування бюджету та великих покупок. Увечері дозвольте собі відпочити з улюбленою книгою."""
        ...
        if not generated_text:
            import random
            generated_text = random.choice(FALLBACK_GREETINGS)
