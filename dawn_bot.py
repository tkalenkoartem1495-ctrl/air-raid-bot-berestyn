    ...
    async def _post_morning_message(self):
        ...
        if history_fact:
            prompt = (
                ...
                "Пиши живою мовою. Розділяй текст логічно, не роби забагато порожніх рядків. "
                "ОБОВ'ЯЗКОВО дотримуйся такого формату абзаців:\n\n"
            ...
            prompt = (
                ...
                "ОБОВ'ЯЗКОВО дотримуйся такого формату абзаців:\n\n"
                "'🌅 Доброго ранку, Берестин!\n\n"
                "Сьогодні [день тижня]. Новий день — новий шанс зробити щось хороше. "
                "Сьогодні очікується [погода].\n"
